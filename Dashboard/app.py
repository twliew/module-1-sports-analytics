...
def optimize_lineup(
    ...
    if len(df) < 4:
        return {"lineup": [], "objective": 0.0, "notes": "Not enough available players to form 4-player lineup."}
    ...
    if not best_combo:
        return {"lineup": [], "objective": 0.0, "notes": f"No feasible lineup under cap {disability_cap}."}
